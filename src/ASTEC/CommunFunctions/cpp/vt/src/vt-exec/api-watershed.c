  ...
  for ( i=firstargc; i<argc; i++ ) {
      ...
      if ( argv[i][0] == '-' ) {
           ...
           */
              ...
              i += 1;
              if ( i >= argc)    API_ErrorParse_watershed( (char*)NULL, "parsing -seeds ...\n", 0 );
              if ( seedsisread  == 0 ) {
              ...
              i += 1;
              if ( i >= argc)    API_ErrorParse_watershed( (char*)NULL, "parsing -gradient ...\n", 0 );
              if ( gradientisread  == 0 ) {
