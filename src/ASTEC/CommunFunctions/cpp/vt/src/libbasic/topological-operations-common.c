...
static int _outside_value_ = _BACKGROUND_VALUE_;

void setNeighborhoodOutsideValueToBackground()
{
  _outside_value_ = _BACKGROUND_VALUE_;
}

void setNeighborhoodOutsideValueToForeground()
{
  _outside_value_ = _FOREGROUND_VALUE_;
}
