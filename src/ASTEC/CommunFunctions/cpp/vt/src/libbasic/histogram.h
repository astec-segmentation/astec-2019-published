...
extern int fprintf1DHistogramMatlab( char* name, FILE *f, int fd,
                                     typeHistogram *h, char *s );
extern int fprintf1DHistogramScilab( char* name, FILE *f, int fd,
                                     typeHistogram *h, char *s );
extern int fprintf2DHistogramScilab( char* name, FILE *f, int fd,
                                     typeHistogram *h, char *s );
...
extern int maxValue( void *theIm, bufferType theType,
