...
extern void VT_LogicOuPatch( vt_image *in1, vt_image *in2, vt_image *out, int ox, int oy, int oz);
extern void VT_LogicEtPatch( vt_image *in1, vt_image *in2, vt_image *out, int ox, int oy, int oz);
extern void VT_LogicXouPatch( vt_image *in1, vt_image *in2, vt_image *out, int ox, int oy, int oz);
