 ...
 *
 * $Id: chamfer.h,v 1.1 2001/03/20 08:24:17 greg Exp $
 *
 ...
 *
 * DESCRIPTION:
 * idem Compute2DChamfer3x3() but the threshold is binarized
 ...
 *
 * DESCRIPTION:
 * idem Compute3DChamfer3x3x3() but the threshold is binarized
 * the input buffer is provided by the user.
 */
