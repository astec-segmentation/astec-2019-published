...
\texttt{FUSE/FUSE\_XXX} under the \texttt{FUSE/} directory
...
'\texttt{XXX}' is given by the variable \texttt{EXP\_FUSE} (its
...
\texttt{<EN>\_fuse\_txxx.inr} where \texttt{xxx} is the time point
...
\subsection{Tuning fusion parameters}
