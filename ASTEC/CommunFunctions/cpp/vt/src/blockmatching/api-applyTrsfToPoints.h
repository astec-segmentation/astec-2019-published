...
typedef struct lineCmdParamApplyTrsfToPoints {
   ...
   */
  char input_points_name[STRINGLENGTH];
  char output_points_name[STRINGLENGTH];
  char input_vtk_name[STRINGLENGTH];
  char output_vtk_name[STRINGLENGTH];
  char input_real_transformation[STRINGLENGTH];

  /* specific arguments
   */
  enumVtkDataEncoding vtkEncoding;
...
extern int API_applyTrsfToVtk( bal_vtkDataSet *theVtk,
