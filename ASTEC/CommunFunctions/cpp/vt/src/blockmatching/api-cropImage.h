...
typedef struct lineCmdParamCropImage {
  ...
  bal_integerVectorialPoint origin;
  bal_integerVectorialPoint dim;
  bal_integerVectorialPoint slice;

  int extractRedComponent;
  int extractGreenComponent;
  int extractBlueComponent;
...
/*
 */
extern int API_INTERMEDIARY_cropSequence( char *theim_format,
                                   int firstindex,
                                   int lastindex,
                                   char *resim_name,
