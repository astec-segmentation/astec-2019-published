...
extern void fprintfTopologicalPoint( FILE *f, topologicalPoint *p );
...
extern void findPointInTopologicalPointListList( topologicalPointListList *list, int x, int y, int z );
 ...
 * neighborhoods.
 */
extern void setNeighborhoodOutsideValueToBackground();
extern void setNeighborhoodOutsideValueToForeground();
