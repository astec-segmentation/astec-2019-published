...
extern int minDoubleImage( double scalar,
                           void *bufferIn1, bufferType typeIn1,
                           void *bufferOut, bufferType typeOut,
                           int *bufferDims );

extern int maxDoubleImage( double scalar,
                           void *bufferIn1, bufferType typeIn1,
                           void *bufferOut, bufferType typeOut,
                           int *bufferDims );

extern int addDoubleImage( double scalar,
                           void *bufferIn1, bufferType typeIn1,
                           void *bufferOut, bufferType typeOut,
                           int *bufferDims );

extern int subtractDoubleImage( double scalar,
                                void *bufferIn1, bufferType typeIn1,
                                void *bufferOut, bufferType typeOut,
                                int *bufferDims );

extern int multiplyDoubleImage( double scalar,
                                void *bufferIn1, bufferType typeIn1,
                                void *bufferOut, bufferType typeOut,
                                int *bufferDims );

extern int divideDoubleImage( double scalar,
                              void *bufferIn1, bufferType typeIn1,
                              void *bufferOut, bufferType typeOut,
                              int *bufferDims );
...
extern int sqrtImage( void *bufferIn, bufferType typeIn,
                     void *bufferOut, bufferType typeOut,
                     int *bufferDims );
