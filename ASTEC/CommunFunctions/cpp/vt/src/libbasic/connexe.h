...
extern int getVerboseInConnexe( );
...
extern void setDebugInConnex( int d );
extern int getDebugInConnex( );
extern void incrementDebugInConnex( );
extern void decrementDebugInConnex( );
