				       ...
				       bufferType type )
{
  ...
  dfield = (distanceField *)vtmalloc( sizeof(distanceField), "dfield", proc );
  ...
  dfield->x = (void*)vtmalloc( size, "dfield->x", proc );
...
void VT_FreeDistanceField( distanceField *dfield )
{
  ...
  if ( dfield->x != (void*)NULL ) vtfree( (void*)(dfield->x) );
  if ( dfield->y != (void*)NULL ) vtfree( (void*)(dfield->y) );
  if ( dfield->z != (void*)NULL ) vtfree( (void*)(dfield->z) );
  vtfree( (void*)dfield );
  return;
}
